...
// HTML со всеми телефонами для мобильного выпадающего меню
$dsever_header_phones_mobile_html = "";
foreach ($dsever_header_phones as $dsever_header_phone) {
	$dsever_header_phones_mobile_html .= '<a class="nav-link top-menu-tel pt-1 pb-1" href="tel:' . $dsever_header_phone["tel"] . '">' . $dsever_header_phone["display"] . "</a>";
}
?>
<!DOCTYPE html>
<html lang="ru">
...
<head>
	...
	<link rel="shortcut icon" href="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/favicon.svg" type="image/svg+xml">
...
<body <?php body_class(); ?>>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent1">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
					...
					<?php foreach ($dsever_header_phones as $dsever_header_phone_i => $dsever_header_phone): ?>
					<li class="nav-item me-4<?php echo $dsever_header_phone_i > 0 ? " d-none d-xl-block" : ""; ?>">
						<a class="top-menu-tel nav-link" href="tel:<?php echo esc_attr($dsever_header_phone["tel"]); ?>">
							<div style="display: flex;" class="align-items-center">
								<div class="nav-li-float-left">
								...
								<div class="nav-li-float-right" style="text-wrap: nowrap;">
									<?php echo esc_html($dsever_header_phone["display"]); ?>
								</div>
								<div style="clear: both;"></div>
							</div>
						</a>
	...
	<!-- Header 2 -->
	<nav id="top-menu-2" class="navbar navbar-expand-lg navbar-light bg-white shadow py-1 py-lg-0">
		<div class="container">
			...
			<div class="d-lg-none">
				<a class="top-menu-tel pt-1 pb-0" href="tel:<?php echo esc_attr($dsever_header_phones[0]["tel"]); ?>"><?php echo esc_html($dsever_header_phones[0]["display"]); ?></a>
    	...
    	"items_wrap" =>
    		...
    		'
										<div class="mb-2" style="font-size: 12px; font-family: HelveticaNeueCyr-Light; text-transform: none;">
											<img src="' .
    		get_stylesheet_directory_uri() .
    		'/img/ico/clock-ico.svg" style="width: 10px; position: relative; top: 2px;" class="me-1 mb-2">Пн-Пт с 9:00 до 18:00
										</div>
									</li>
