	...
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-lg-10 col-md-10 mx-auto item_text">
				<p>Наша компания изготавливает фасады для мебели из МДФ, шпона, массива дерева, ЛДСП. Фасады из МДФ могут быть как прямыми, так и фрезерованными. Затем мы покрасим их в любой, выбранный Вами цвет.</p>
					...
					<table class="table">
						<tbody>
							<tr class="bg-white">
								...
								<td class="text-end">
									<span class="price-discount bg-white" style="color: #FF5147; font-weight: 600;">по договоренности</span>
								</td>
							</tr>
						</tbody>
					</table>
	...
	<div class="container">
		<div class="row justify-content-between">
			...
			<div class="col-12 col-lg-5 offset-lg-1 order-1 order-lg-last mb-5 mb-lg-0 about" style="padding-left: 24px;">
				...
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/section-title-dec.svg" class="mb-5">
				<p class="text-start" style="line-height: 27px; margin-bottom: 60px;">За много лет работы компании «Декор-Север» нами накоплен большой практический опыт в изготовлении мебельных фасадов. Мы тщательно подобрали профессиональное оборудование и полностью укомплектованы высококлассными специалистами, в совершенстве владеющими различными технологическими приемами и изучившими мельчайшие нюансы своего дела. Нашим клиентам гарантированы качественные и красивые фасады для любого вида мебели, из всех возможных выпускающихся материалов, в самые короткие сроки и по очень привлекательным расценкам, которые оговариваются при заказе требуемой услуги.</p>
