...
if (!empty($_POST)) {
	...
	if ($captcha->success == true && $captcha->score > 0.125) {
		...
		if ($phone) {
			...
			$features = array_filter([$_POST["form-answer-2-kitchen-1"] ?? "", $_POST["form-answer-2-kitchen-2"] ?? "", $_POST["form-answer-2-kitchen-3"] ?? ""]);
			...
			$body =
				...
				$phone .
				'</p>
                <p><strong>Способы связи:</strong> ' .
				$contact_methods_str .
				'</p>
                <hr>
                <h3>Параметры кухни</h3>
                <p><strong>Планировка:</strong> ' .
				$answer1 .
				'</p>
                <p><strong>Дополнительные особенности:</strong> ' .
				$features_str .
				'</p>
                <p><strong>Размеры кухни:</strong> ' .
				$kitchen_size .
				'</p>
                <p><strong>Стиль:</strong> ' .
				$answer4 .
				'</p>
                <p><strong>Материал фасада:</strong> ' .
				$answer5 .
				'</p>
                <p><strong>Бюджет:</strong> ' .
				$answer6 .
				'</p>
                <p><strong>Подарок:</strong> ' .
				$answer7 .
				'</p>
                </body></html>';
